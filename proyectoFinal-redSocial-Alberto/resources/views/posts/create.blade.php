...
@section('contenido')
    <div class="md:flex md:items-center">
        <div class="md:w-1/2 px-10">
            ...
            <p class="text-sm text-gray-500 mt-2">Sube una imagen cuadrada para tu publicación (máx. 5&nbsp;MB).</p>
        </div>
        <div class="md:w-1/2 p-10 md:justify-center bg-white rounded-lg shadow-xl mt-10 md:mt-0">
            <form action="{{route('posts.store')}}" method="POST" novalidate>
                ...
                @enderror
                <div class="mb-5">
                    <label for="titulo" class="mb block uppercase text-gray-500 font-bold">Titulo</label>
                    <input
                        id="titulo"
                        name="titulo"
                        type="text"
                ...
                <div class="mb-5">
                    <label for="descripcion" class="mb block uppercase text-gray-500 font-bold">Descripción</label>
                    <textarea
                        id="descripcion"
                        name="descripcion"
