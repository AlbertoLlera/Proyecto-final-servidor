...
@section('contenido')
    <div class="max-w-3xl mx-auto bg-white border border-gray-200 rounded-xl p-6 space-y-6">
        <form action="{{ route('admin.comments.store') }}" method="POST" class="space-y-6">
            @include('admin.comments._form')

            <div class="flex justify-end gap-3">
                <a href="{{ route('admin.comments.index') }}" class="px-4 py-2 border border-gray-300 rounded-lg text-sm">Cancelar</a>
